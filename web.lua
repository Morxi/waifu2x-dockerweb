...
cmd:option("-max_pixels", 100000 * 100000, 'maximum number of output image pixels (e.g. 3000x3000=9000000)')
...
cmd:option("-max_body_size", 5 * 30000 * 30000, "maximum allowed size for uploaded files")
cmd:option("-cache_max", 500, "number of cached images on RAM")
